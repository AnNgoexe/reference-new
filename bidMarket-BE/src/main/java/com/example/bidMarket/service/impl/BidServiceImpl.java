...
//        if (
////                bidRequest.getBidTime().isBefore(auction.getStartTime()) ||
//                bidRequest.getBidTime().isAfter(auction.getEndTime())
//
...
//        }
//        if (bidRequest.getBidTime().isBefore(auction.getStartTime())
//        ) {
//            log.error("Bid time is before start time");
//            bid.setStatus(BidStatus.INVALID);
//        }

        if (bidRequest.getBidTime().isAfter(auction.getEndTime())){
            log.error("Bid time after end time");
            bid.setStatus(BidStatus.INVALID);
        }

//        if (bidRequest.getBidTime().isBefore(auction.getLastBidTime())){
//            log.error("Bid time not synchronized");
//            bid.setStatus(BidStatus.INVALID);
//        }
